...
describe("Notification Component", () => {
  ...
  it("div.Notification is not being displayed when displayDrawer is false", () => {
    const wrapper = shallow(<Notifications />);
    wrapper.update();
  ...
  it("div.Notification is not being displayed when displayDrawer is true", () => {
    const wrapper = shallow(<Notifications displayDrawer />);
    wrapper.update();
    const item = wrapper.find("div#Notifications");
    expect(item).toHaveLength(1);
  ...
  describe("Notifications without listNotifications or empty listNotification", () => {
    beforeEach(() => {
      listNotifications = [];
    });
